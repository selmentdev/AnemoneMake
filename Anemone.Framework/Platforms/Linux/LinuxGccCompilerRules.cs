...
internal sealed class LinuxGccCompilerRules : CompilerRules
{
    private readonly LinuxPlatformRules m_Platform;

    public LinuxGccCompilerRules(LinuxPlatformRules platform, ResolvedModule module, CompilerDescriptor descriptor)
