...
internal sealed class LinuxGccAssemblerRules : CompilerRules
{
    private readonly LinuxPlatformRules m_Platform;

    public LinuxGccAssemblerRules(LinuxPlatformRules platform, ResolvedModule module, CompilerDescriptor descriptor)
