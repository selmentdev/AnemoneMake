...
internal sealed class LinuxClangLinkerRules : LinkerRules
{
    private readonly LinuxPlatformRules m_Platform;

    public LinuxClangLinkerRules(LinuxPlatformRules platform, ResolvedModule module, LinkerDescriptor descriptor)
