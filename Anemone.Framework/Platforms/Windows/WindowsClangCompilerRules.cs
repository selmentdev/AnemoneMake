...
internal sealed class WindowsClangCompilerRules : CompilerRules
{
    private readonly WindowsPlatformRules m_Platform;

    public WindowsClangCompilerRules(WindowsPlatformRules platform, ResolvedModule module, CompilerDescriptor descriptor)
