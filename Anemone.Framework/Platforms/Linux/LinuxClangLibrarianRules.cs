...
internal sealed class LinuxClangLibrarianRules : LinkerRules
{
    public LinuxClangLibrarianRules(LinuxPlatformRules _, ResolvedModule module, LinkerDescriptor descriptor)
